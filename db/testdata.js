	...
	recipes: [
		{
			...
			directions: {
				value: `1) Heat the oil in a large frying pan over medium heat until shimmering. Add the onions and bell pepper, season with salt, and cook, stirring occasionally, until softened, about 8 minutes.
        ...
        4)Stir in the jalapeños or green chiles. Taste and season with salt as needed, and serve with the cheese, scallions, and sour cream.`},
			...
			method: { value: 'Slow Cooked' },
			categories: { value: ['Meal'] }
		},
		{
			id: '2',
			name: { value: 'Mac & Cheese' },
			ingredients: {
				value: [
					{ name: 'yellow onion', quantity: 2, unit: '' },
					{ name: 'red capsicum', quantity: 1, unit: '' },
        ...
        4)Stir in the jalapeños or green chiles. Taste and season with salt as needed, and serve with the cheese, scallions, and sour cream.`},
			...
			activeTime: { value: 45 },
			previewImage:
				{ value: 'https://img.buzzfeed.com/thumbnailer-prod-us-east-1/video-api/assets/167797.jpg' },
			recipeSource: { value: 'https://tasty.co/recipe/tasty-101-buttermilk-pancakes' },
			method: { value: 'Slow Cooked' },
			categories: { value: ['Meal'] }
		},
		{
			id: '4',
			name: { value: 'Test 1 with a really long that might break layout' },
			ingredients: {
				value: [
					{ name: 'yellow onion', quantity: 2, unit: '' },
					{ name: 'red capsicum', quantity: 1, unit: '' },
        ...
        4)Stir in the jalapeños or green chiles. Taste and season with salt as needed, and serve with the cheese, scallions, and sour cream.`},
			...
			activeTime: { value: 45 },
			previewImage:
				{ value: 'https://c-7npsfqifvt34x24tfbsdix2edipx78x2edpn.g00.chowhound.com/g00/3_c-7x78x78x78.dipx78ipvoe.dpn_/c-7NPSFQIFVT34x24iuuqtx3ax2fx2ftfbsdi.dipx78.dpnx2fuivncobjmx2f2391x2f1x2fx78x78x78.dipx78tubujd.dpnx2fbttfutx2f3125x2f10x2f41770_tqjdz_tmpx78_dpplfs_cffg_dijmj_4111y3111.kqhx3fj21d.nbslx3djnbhf_$/$/$/$/$/$/$/$/$' },
			recipeSource:
				{ value: 'https://www.chowhound.com/recipes/spicy-slow-cooker-beef-chili-30669' },
			method: { value: 'Slow Cooked' },
			categories: { value: ['Meal'] }
		},
		{
