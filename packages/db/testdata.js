const book1 = {
  ...
  recipes: [
    ...
    },
    {
      ...
      activeTime: { value: 45 },
      previewImage: {
        value: 'https://images.media-allrecipes.com/userphotos/560x315/5193809.jpg',
      },
      recipeSource: {
        value:
    ...
    },
    {
      ...
      waitingTime: { value: 360 },
      activeTime: { value: 45 },
      previewImage: { value: 'https://img.buzzfeed.com/thumbnailer-prod-us-east-1/video-api/assets/167797.jpg' },
    ...
    },
    {
      ...
      recipeSource: { value: 'https://www.chowhound.com/recipes/spicy-slow-cooker-beef-chili-30669' },
      method: { value: 'Slow Cooked' },
      categories: { value: ['Meal'] },
    },
    {
